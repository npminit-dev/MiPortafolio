...
<template>
  <div id="convergent-dots-container"
    ...
    <div id="stars-container" class="absolute px-8 h-full w-full inset-x-0 -bottom-1/4 overflow-visible">
      <div v-for="star in stars" :key="star.id" class="absolute rounded-full bg-ghost-300" :style="{
        top: star.top,
        left: star.left,
        width: star.size,
        height: star.size
