...
<template>
  <svg ref="svgRef" :height="height || 600" viewBox="0 0 1008 1008" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g id="planet6-with-moon">
      ...
      <path id="planet6-moon-orbit-path" stroke="var(--color-shadow-500)" stroke-width="0.5"
        vector-effect="non-scaling-stroke"
        d="M477.2181 126.122a26.7819 26.7819 0 1 0 53.5638 0a26.7819 26.7819 0 1 0 -53.5638 0" />
      <!-- Luna del planeta 6 -->
      <path id="planet6-moon" fill="var(--color-ghost-300)"
    ...
    <g id="planet7-with-moon">
      ...
      <path id="planet7-moon-orbit-path" stroke="var(--color-shadow-500)" stroke-width="0.5"
        vector-effect="non-scaling-stroke"
        d="M490.2554 753.928a13.7446 13.7446 0 1 0 27.4892 0a13.7446 13.7446 0 1 0 -27.4892 0" />
      <!-- Luna del planeta 7 -->
      <path id="planet7-moon" fill="var(--color-ghost-300)"
        d="M502.6651 740.145a1.3349 1.3349 0 1 0 2.6698 0a1.3349 1.3349 0 1 0 -2.6698 0" />
    </g>
    <!-- Planeta 8 -->
    <path id="planet8" fill="var(--color-ghost-300)"
