...
watchEffect(() => {
  if (
    ...
    gsap.set([binaryLine.value, memoryLine.value, bracesLine.value], {
      drawSVG: "100% 100%",
    });
    gsap.set([binaryCircle.value, memoryCircle.value, bracesCircle.value], {
      drawSVG: "0% 0%",
    });
    gsap.set([binaryContent.value, memoryContent.value, bracesContent.value], {
      autoAlpha: 0,
    });
...
<template>
  ...
  <circle
    ...
    cy="336.442"
    r="76.5"
    transform="rotate(45 338.45 336.442)"
  ...
  <circle
    ...
    cy="336.442"
    r="24.5"
    transform="rotate(90 136.408 336.442)"
    stroke="var(--color-ghost-200)"
    vector-effect="non-scaling-stroke"
  />
  <g ref="binary-content">
    <path
      d="M132.799 323.552L126.611 323.552L126.611 332.833L132.799 332.833L132.799 323.552Z"
      stroke="var(--color-ghost-200)"
      vector-effect="non-scaling-stroke"
      stroke-width="1.5"
    ...
    />
    <path
      d="M140.018 332.833L146.205 332.833M140.018 323.552H143.111L143.111 331.802"
      stroke="var(--color-ghost-200)"
      stroke-width="1.5"
      vector-effect="non-scaling-stroke"
      stroke-linecap="round"
    ...
    />
    <path
      d="M146.205 340.052L140.018 340.052L140.018 349.333L146.205 349.333L146.205 340.052Z"
      stroke="var(--color-ghost-200)"
      vector-effect="non-scaling-stroke"
      stroke-width="1.5"
      stroke-linecap="round"
    ...
    />
    <path
      d="M126.611 349.333L132.799 349.333M126.611 340.052H129.705L129.705 348.302"
      stroke="var(--color-ghost-200)"
      stroke-width="1.5"
      vector-effect="non-scaling-stroke"
      stroke-linecap="round"
  ...
  <circle
    ...
    cy="193.178"
    r="24.5"
    transform="rotate(180 197.312 193.178)"
    stroke="var(--color-ghost-200)"
    vector-effect="non-scaling-stroke"
  />
  ...
  <circle
    ...
    cy="481.464"
    r="24.5"
    transform="rotate(90 199.408 481.464)"
    stroke="var(--color-ghost-200)"
    vector-effect="non-scaling-stroke"
  />
