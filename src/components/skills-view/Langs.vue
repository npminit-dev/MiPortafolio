...
onMounted(() => {
  ...
  const shiftingContainer = document.querySelector(
    "#langs-shifting-container"
  ) as HTMLElement;
...
<template>
  <div
    class="main-container relative w-[100dvw] h-[100dvh] flex flex-col items-center justify-start border-yellow-500"
  >
    <div class="flex flex-col items-center justify-center pb-4 sm:pb-8 md:pb-16">
    ...
    <div class="border-white box-content w-[100dvw]">
      <div
        id="langs-masked-container"
        class="h-[calc(100dvh-140px)] sm:h-[calc(100dvh-175px)] md:h-[calc(100dvh-210px)] px-[calc(50dvw)] w-full"
      >
        <div ref="langs-pinned-container" class="h-full w-fit">
          <div
            id="langs-shifting-container"
            class="relative w-[4152px] rotate-z-45 h-full bg-gradient-to-r origin-[left_center] flex items-center justify-between"
          >
            <!-- SVG SVG SVG -->
            <svg
              class="-rotate-z-45 -mx-56"
              width="4152"
              height="3290"
              viewBox="0 0 3290 3290"
              fill="none"
              ...
              <defs>
                <clipPath id="clip0_2084_108">
                  <rect
                    ...
                    height="104"
                    fill="white"
                    transform="translate(939.68 939.138)"
                  />
                </clipPath>
                <clipPath id="clip1_2084_108">
                  <rect
                    ...
                    height="32"
                    fill="white"
                    transform="translate(836.408 833.177)"
                  />
                </clipPath>
                <clipPath id="clip2_2084_108">
                  <rect
                    ...
                    height="38"
                    fill="white"
                    transform="translate(1110.41 1106.03)"
                  />
                </clipPath>
                <clipPath id="clip3_2084_108">
                  <rect
                    ...
                    height="31"
                    fill="white"
                    transform="translate(1486.91 1482.45)"
                  />
                </clipPath>
                <clipPath id="clip4_2084_108">
                  <rect
                    ...
                    height="32"
                    fill="white"
                    transform="translate(2137.41 2131.59)"
                  />
                </clipPath>
                <clipPath id="clip5_2084_108">
                  <rect
                    ...
                    height="31"
                    fill="white"
                    transform="translate(2454 2419.11) rotate(90)"
                  />
                </clipPath>
                <clipPath id="clip6_2084_108">
                  <rect
                    ...
                    height="44"
                    fill="white"
                    transform="translate(3138 2917.59)"
                  />
                </clipPath>
                <clipPath id="clip7_2084_108">
                  <rect
                    ...
                    height="36"
                    fill="white"
                    transform="translate(3081.91 2771.87)"
                  />
                </clipPath>
                <clipPath id="clip8_2084_108">
                  <rect
                    ...
                    height="33"
                    fill="white"
                    transform="translate(3080.66 3076.43)"
                  />
                </clipPath>
              </defs>
            </svg>
